...
import com.winbee.quizhat.activity.ThirdLevelActivity;
import com.winbee.quizhat.model.SLDetailsDataModel;

import java.util.List;

public class SecondLevelTestListAdapter extends RecyclerView.Adapter<SecondLevelTestListAdapter.CustomViewHolder> {
    private Context context;
    private List<SLDetailsDataModel> slDetailsDataModelList;
    private View view;

    public SecondLevelTestListAdapter(Context context, List<SLDetailsDataModel> slDetailsDataModelList) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder viewHolder, int position) {
        final SLDetailsDataModel siacDetailsDataModel = slDetailsDataModelList.get(position);
        ...
        viewHolder.branch_live1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(context, ThirdLevelActivity.class);
